...
class SceneDelegate: FlutterSceneDelegate {
  // Must match ColdTapReader._dartKey (with the `flutter.` SharedPreferences
  // prefix on the native side).
  static let launchRouteKey = "flutter.hys_launch_route"
  ...
  override func scene(
    ...
    #if DEBUG
    NSLog("[HYS.ROUTE] captured notification destination")
    #endif
  }
