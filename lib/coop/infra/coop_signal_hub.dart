...
Future<void> henBackgroundMessage(RemoteMessage _) async {}

class CoopSignalHub {
  CoopSignalHub(this._store, {required this.enabled});
  ...
  Future<void> _boot() async {
    ...
    FirebaseMessaging.onBackgroundMessage(henBackgroundMessage);
