...
class YardAgent extends http.BaseClient {
  ...
  String _normalizedIos(String raw) {
    final components = raw
        ...
        .take(3)
        .toList();
    if (components.isEmpty || components.first < 17) return '18.5';
  ...
  String _mobileSafari(String iosVersion) {
    ...
    return 'Mozilla/5.0 (iPhone; CPU iPhone OS $cpu like Mac OS X) '
        'AppleWebKit/${CoopRelayConfig.webKitVersion} (KHTML, like Gecko) '
        'Version/${CoopRelayConfig.safariVersion} Mobile/15E148 '
        'Safari/${CoopRelayConfig.safariTail}';
  }
