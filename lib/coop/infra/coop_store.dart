...
class CoopStore {
  static const String _routeKey = 'hys.coop.route';
  static const String _expiryKey = 'hys.coop.expiry';
  static const String _inviteKey = 'hys.coop.invite.after';
  static const String _permissionKey = 'hys.coop.push.allowed';
  static const String _osDeniedKey = 'hys.coop.push.os_denied';
  static const String _savedUrlKey = 'hys.coop.secure.destination';
  static const String _pendingUrlKey = 'hys.coop.secure.pending';
  ...
  SprintRoute get route => SprintRoute.parse(_preferences.getString(_routeKey));

  Future<void> saveRoute(SprintRoute route) =>
