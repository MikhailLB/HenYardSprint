...
class NoLinePage extends StatefulWidget {
  const NoLinePage({
    super.key,
    required this.probe,
  ...
  @override
  State<NoLinePage> createState() => _NoLinePageState();
}

class _NoLinePageState extends State<NoLinePage> {
  ...
  void initState() {
    ...
    // Allow landscape so the offline artwork rotates (SprintGate locks
